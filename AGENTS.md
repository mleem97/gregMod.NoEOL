# AGENTS.md — Hinweise für KI-Agenten (gregMod.NoEOL)

Repo: [https://github.com/mleem97/gregMod.NoEOL](https://github.com/mleem97/gregMod.NoEOL) · Lizenz: Apache-2.0 · Version: siehe `VERSION`.
